...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
  ...
  */
  ...
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    /* command ID #23 - DS 1 HZ Wakeup (UNUSED: DS has no 1Hz wakeup MID. This
       was wrongly set to DS_HK_TLM_MID, which made SCH emit an 8-byte phantom
       packet on the DS HK telemetry APID 0x08B8 -> "DS_HKPACKET len 8" on the
       ground. DS still gets real HK via the DS_SEND_HK_MID slot above.) */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
  ...
  */
  ...
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    ...
    /* command ID #40 - EPS HK */
  { { CFE_MAKE_BIG16(EPS_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #41 */
  { { CFE_MAKE_BIG16(SP_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #42 */
  { { CFE_MAKE_BIG16(SYSMON_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #43 */
  { { CFE_MAKE_BIG16(CAMERA_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #44 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },  
    /* command ID #45 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
  ...
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    ...
    /* command ID #110 - SPACECOP HK */
  { { CFE_MAKE_BIG16(SPACECOP_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #111 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) }},
    /* command ID #112 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
