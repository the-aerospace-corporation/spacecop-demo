    ...
    switch (CommandCode)
    {
        ...
        */
        ...
        case CFDP_UPLOADFILE_DATA_CC:
            ...
            break;
        /*
        ** Class 2 NAK: resend a specific missing chunk
        */
        case CFDP_RESENDCHUNK_CC:
            if (CFDP_VerifyCmdLength(CFDP_AppData.MsgPtr, sizeof(CFDP_ResendChunk_t)) == OS_SUCCESS)
            {
                CFDP_ResendChunk(CFDP_AppData.MsgPtr);
            }
            break;
