 ...
 *
 * Purpose:
 * Extra scaffolding functions for the sysmon_app unit test
 *
 * Notes:
...
#ifndef UT_SYSMON_APP_H
#define UT_SYSMON_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "SYSMON_APP_Data_t" typedef.
 */
#include "sysmon_app.h"

/*
 * Allow UT access to the global "SYSMON_APP_Data" object.
 */
//extern SYSMON_AppData_t SYSMON_APP_Data;

#endif /* UT_SYSMON_APP_H */
