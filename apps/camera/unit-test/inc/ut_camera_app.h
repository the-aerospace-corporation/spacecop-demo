 ...
 *
 * Purpose:
 * Extra scaffolding functions for the camera_app unit test
 *
 * Notes:
...
#ifndef UT_CAMERA_APP_H
#define UT_CAMERA_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "CAMERA_APP_Data_t" typedef.
 */
#include "camera_app.h"

/*
 * Allow UT access to the global "CAMERA_APP_Data" object.
 */
//extern CAMERA_AppData_t CAMERA_APP_Data;

#endif /* UT_CAMERA_APP_H */
