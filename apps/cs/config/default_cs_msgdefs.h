 ...
 *   messages.
 */
#ifndef DEFAULT_CS_MSGDEFS_H
#define DEFAULT_CS_MSGDEFS_H

#include "common_types.h"
#include "cs_fcncodes.h"
...
typedef struct
{
    char Name[CFE_MISSION_TBL_MAX_FULL_NAME_LEN]; /**< \brief Table name to perform a command on */
...
typedef struct
{
    char Name[CFE_MISSION_MAX_API_LEN]; /**< \brief App name to perform a command on */
