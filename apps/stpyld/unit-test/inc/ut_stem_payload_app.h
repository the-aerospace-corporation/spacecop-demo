 ...
 *
 * Purpose:
 * Extra scaffolding functions for the stem_payload_app unit test
 *
 * Notes:
...
#ifndef UT_STEM_PAYLOAD_APP_H
#define UT_STEM_PAYLOAD_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "STEM_PAYLOAD_APP_Data_t" typedef.
 */
#include "stem_payload_app.h"

/*
 * Allow UT access to the global "STEM_PAYLOAD_APP_Data" object.
 */
//extern STEM_PAYLOAD_AppData_t STEM_PAYLOAD_APP_Data;

#endif /* UT_STEM_PAYLOAD_APP_H */
