...
/*
** File: coveragetest_eps_app.c
**
** Purpose:
** Coverage Unit Test cases for the EPS Application
**
** Notes:
** This implements various test cases to exercise all code
** paths through all functions defined in the EPS application.
**
...
/* to get the EPS_LIB_Function() declaration */
...
void Test_EPS_AppMain(void)
{
     ...
     */
    UtAssert_True(EventTest.MatchCount == 1, "EPS_PIPE_ERR_EID generated (%u)",
...
void Test_EPS_ProcessCommandPacket(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetFcnCode), &FcnCode, sizeof(FcnCode), false);
    EPS_ProcessCommandPacket();
    UtAssert_True(EventTest.MatchCount == 1, "EPS_CMD_ERR_EID generated (%u)",
                  (unsigned int)EventTest.MatchCount);
}
...
void Test_EPS_ReportHousekeeping(void)
{
    ...
    UtAssert_True(MsgSend == &EPS_AppData.HkTelemetryPkt.TlmHeader.Msg, "CFE_SB_TransmitMsg() address matches expected");
...
void Test_EPS_VerifyCmdLength(void)
{
     ...
     * Confirm that the event WAS generated
     */
    UtAssert_True(EventTest.MatchCount == 1, "EPS_LEN_ERR_EID generated (%u)",
                  (unsigned int)EventTest.MatchCount);
}
